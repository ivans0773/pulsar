...
public class ServiceConfiguration implements PulsarConfiguration {
    ...
    @FieldContext(
            category = CATEGORY_POLICIES,
            doc = "If enabled subscriptions stores sticky keys of messages which allows consumer not "
                    ...
                    + "which could potentially lead to perfrormance degradation and higher memory consumtion"
    )
    private boolean rememberNotAckedMessageStickyKey = false;
    @FieldContext(
            category = CATEGORY_POLICIES,
